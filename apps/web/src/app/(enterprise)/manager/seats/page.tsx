...
import { SEAT_DOWNGRADE_CODE, type SeatSummary } from "@/lib/enterprise/manager-api";
import {
  useAssignSeat,
  useReleaseSeat,
  useResizeSeats,
...
function SeatSummaryPanel({ summary }: { summary: SeatSummary | null }) {
  const { t } = useI18n();
  if (!summary) {
    return (
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="lg:col-span-1">
          <QueryState query={summary}>{(data) => <SeatSummaryPanel summary={data} />}</QueryState>
        </div>
        <div className="lg:col-span-1">
          <AssignReleaseForm />
        </div>
